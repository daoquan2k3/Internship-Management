...
public class DashboardServiceImpl implements DashboardService {
        ...
        public StudentStatsResponse getStudentStats(String username) throws ResourceNotFoundException {
                ...
                org.springframework.data.domain.Page<pka.edu.entity.FinalEvaluationForm> formsPage = finalEvaluationFormRepository
                                .findByStudent_StudentId(studentId, org.springframework.data.domain.PageRequest.of(0, 1));
        ...
        public RepStatsResponse getRepStats(String username) throws ResourceNotFoundException {
                ...
                long pendingJoinRequests = joinRequestRepository.countByUniversity_UniversityIdAndStatus(universityId, JoinRequestStatus.PENDING);
                
                long totalEvaluations = finalEvaluationFormRepository.countByUniversityId(universityId);
                long pendingEvaluations = finalEvaluationFormRepository.countByUniversityIdAndRepStatus(universityId, JoinRequestStatus.PENDING);
                long approvedEvaluations = finalEvaluationFormRepository.countByUniversityIdAndRepStatus(universityId, JoinRequestStatus.APPROVED);
