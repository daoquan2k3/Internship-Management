  ...
  return (
    <Box sx={{ maxWidth: "100%", px: { xs: 2, md: 4 }, margin: "0 auto", pb: 5 }}>
      ...
      <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }}>
        <Paper
          sx={{
            ...
            color: "white",
            boxShadow: "0 12px 32px -8px rgba(21, 101, 192, 0.35)",
          }}
        >
          <Box
            sx={{
          ...
          <Stack direction={{ xs: "column", sm: "row" }} alignItems="center" spacing={3.5} sx={{ position: "relative", zIndex: 1 }}>
            ...
            <Box>
              <Typography variant="h3" sx={{ fontWeight: 850, mb: 1, letterSpacing: "-0.5px" }}>
                Chào Đại diện Doanh nghiệp, {user?.fullName || user?.username || "Company Rep"}! 🏢
              </Typography>
              <Typography variant="body1" sx={{ fontWeight: 400, opacity: 0.9, maxWidth: 650 }}>
                Quản lý sinh viên thực tập tại doanh nghiệp, phân công Người hướng dẫn nội bộ (Company Mentor) và thực hiện các đánh giá định kỳ, cuối kỳ.
              </Typography>
            </Box>
          </Stack>
        </Paper>
      ...
      <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", sm: "repeat(2, 1fr)", md: "repeat(4, 1fr)" }, gap: 2.5 }}>
        ...
        <motion.div whileHover={{ y: -6, scale: 1.02 }} transition={{ duration: 0.2 }} style={{ height: "100%" }}>
          <Paper
            ...
            sx={{
              ...
              "&:hover": { borderColor: "#1565c0", boxShadow: "0 12px 28px rgba(21, 101, 192, 0.15)" }
            }}
          >
            <Box>
              <Box sx={{ width: 44, height: 44, borderRadius: 2.5, bgcolor: "#1565c0", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", mb: 2 }}>
                <PeopleAltIcon fontSize="small" />
              </Box>
              <Typography variant="h6" sx={{ fontWeight: 800, fontSize: "1.05rem", mb: 1 }}>Sinh viên & Đơn vào</Typography>
              <Typography variant="body2" color="text.secondary" sx={{ lineHeight: 1.5, fontSize: "0.85rem" }}>
                Xem danh sách sinh viên thực tập tại doanh nghiệp, duyệt đơn xin vào lớp và xác nhận vị trí.
              </Typography>
            </Box>
            <Box sx={{ display: "flex", alignItems: "center", mt: 2.5, color: "#1565c0", fontWeight: 700, fontSize: "0.85rem" }}>
              Truy cập ngay <ArrowForwardIcon sx={{ ml: 0.5, fontSize: 16 }} />
            </Box>
          </Paper>
        </motion.div>

        {/* Card 2: Company Mentors */}
        <motion.div whileHover={{ y: -6, scale: 1.02 }} transition={{ duration: 0.2 }} style={{ height: "100%" }}>
          <Paper
          ...
          >
            <Box>
              ...
              <Typography variant="h6" sx={{ fontWeight: 800, fontSize: "1.05rem", mb: 1 }}>Người hướng dẫn nội bộ</Typography>
              <Typography variant="body2" color="text.secondary" sx={{ lineHeight: 1.5, fontSize: "0.85rem" }}>
                Thêm mới, cập nhật danh sách Company Mentor và phân công hướng dẫn từng sinh viên.
              </Typography>
            </Box>
        ...
        {/* Card 3: Periodic Feedback & Mid-term */}
        <motion.div whileHover={{ y: -6, scale: 1.02 }} transition={{ duration: 0.2 }} style={{ height: "100%" }}>
          <Paper
          ...
          >
            <Box>
              ...
              <Typography variant="h6" sx={{ fontWeight: 800, fontSize: "1.05rem", mb: 1 }}>Phản hồi & Đánh giá giữa kỳ</Typography>
              <Typography variant="body2" color="text.secondary" sx={{ lineHeight: 1.5, fontSize: "0.85rem" }}>
                Gửi nhận xét phản hồi định kỳ (Periodic Feedback) và thực hiện đánh giá giữa kỳ.
              </Typography>
            </Box>
        ...
        {/* Card 4: Final Reports & Evaluations */}
        <motion.div whileHover={{ y: -6, scale: 1.02 }} transition={{ duration: 0.2 }} style={{ height: "100%" }}>
          <Paper
            onClick={() => navigate("/management/reports")}
            sx={{
              p: 2.5, borderRadius: 4, cursor: "pointer", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between",
              background: "linear-gradient(135deg, rgba(142, 36, 170, 0.08) 0%, rgba(142, 36, 170, 0.02) 100%)",
              border: "1px solid rgba(142, 36, 170, 0.2)",
              boxShadow: "0 4px 12px rgba(0,0,0,0.03)",
              "&:hover": { borderColor: "#8e24aa", boxShadow: "0 12px 28px rgba(142, 36, 170, 0.15)" }
            }}
          >
            <Box>
              <Box sx={{ width: 44, height: 44, borderRadius: 2.5, bgcolor: "#8e24aa", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", mb: 2 }}>
                <EmojiEventsIcon fontSize="small" />
              </Box>
              <Typography variant="h6" sx={{ fontWeight: 800, fontSize: "1.05rem", mb: 1 }}>Báo cáo & Đánh giá cuối kỳ</Typography>
              <Typography variant="body2" color="text.secondary" sx={{ lineHeight: 1.5, fontSize: "0.85rem" }}>
                Nhận và lưu trữ báo cáo cuối kỳ, phê duyệt và gửi đánh giá tổng thể cho sinh viên.
              </Typography>
            </Box>
            <Box sx={{ display: "flex", alignItems: "center", mt: 2.5, color: "#8e24aa", fontWeight: 700, fontSize: "0.85rem" }}>
              Truy cập ngay <ArrowForwardIcon sx={{ ml: 0.5, fontSize: 16 }} />
            </Box>
          </Paper>
        </motion.div>
...
export default CompanyRepDashboard;
