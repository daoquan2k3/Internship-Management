...
const AssessmentRoundDetail = () => {
    ...
    return (
        <Box sx={{ p: { xs: 2, md: 4 }, maxWidth: "900px", margin: "0 auto", backgroundColor: "background.default", minHeight: '100vh' }}>
            ...
            <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
                <Paper elevation={0} sx={{ p: { xs: 3, md: 5 }, mb: 4, borderRadius: 4, background: 'linear-gradient(135deg, #ffffff, #fcfcfc)', boxShadow: '0 12px 32px rgba(0,0,0,0.05)',  }}>

                    <Box sx={{ mb: 1 }}>
                        <Typography variant="h3" sx={{ fontWeight: '900', color: "primary.light", mb: 1.5, letterSpacing: '-0.5px' }}>
                        ...
                        round.roundCriteria.map((c, index) => (
                            <motion.div key={index} variants={itemVariants}>
                                <Paper
                                    elevation={0}
                                    sx={{
                                        p: 3, bgcolor: "background.paper", borderRadius: 3, border: '1px solid #e0e0e0',
